#!/bin/bash
#SBATCH --job-name=mummer_Pyranica                  # Job name for SLURM scheduler
...
# The command compares the reference genome C_excelsa_V5.fa against the query genome CPYR002.HapHiC.04.build.scaffolds.fasta
