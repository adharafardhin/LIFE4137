#!/bin/bash
#SBATCH --job-name=Liftoff_Pyranica_1_default        # Job name for SLURM scheduler
...
# The command transfers annotations from C_excelsa_V5.fa to CPYR002.HapHiC.04.build.scaffolds.fasta
liftoff -g /share/Yant_Group_Shared/Adhara/Liftoff/C_excelsa_V5_braker2_wRseq.gff3 \
        -o /share/Yant_Group_Shared/Adhara/Liftoff/output_liftoff_Pyranica/output_liftoff_Pyr.gff3 \
        -u unmapped_features_Pyr.txt \
        -dir intermediate_files_Pyr \
        /share/Yant_Group_Shared/Adhara/Liftoff/CPYR002.HapHiC.04.build.scaffolds.fasta \
